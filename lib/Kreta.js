...
class Kreta {
	...
	async getAbsences(accessToken, from, to) {
		return await absences.getAbsences(accessToken, from, to);
	}
	...
	async getEvaluations(accessToken, from, to) {
		return await evaluations.getEvaluations(accessToken, from, to);
	}
	...
	async getExams(accessToken, from, to) {
		return await exams.getExams(accessToken, from, to);
	}
	...
	async getNotes(accessToken, from, to) {
		return await notes.getNotes(accessToken, from, to);
	}
